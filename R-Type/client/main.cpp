...
int main(void)
{
    ...
    // create background
    engine.getECS().getEntityManager().addMask(0, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    ...
    engine.getECS().getEntityManager().addMask(1, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    engine.getECS().getComponentManager().initEmptyComponent();
    ...
    engine.getECS().getEntityManager().addMask(2, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    engine.getECS().getComponentManager().initEmptyComponent();
    ...
    engine.getECS().getEntityManager().addMask(3, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    engine.getECS().getComponentManager().initEmptyComponent();
    ...
    engine.getECS().getEntityManager().addMask(4, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    engine.getECS().getComponentManager().initEmptyComponent();
    ...
    engine.getECS().getEntityManager().addMask(5, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PAR));
    engine.getECS().getComponentManager().initEmptyComponent();
    ...
    // create spaceship
    engine.getECS().getEntityManager().addMask(6, (eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::SPRITEID | eng::InfoEntity::SPEED | eng::InfoEntity::CONTROLLABLE | eng::InfoEntity::COOLDOWNSHOOT));
    engine.getECS().getComponentManager().initEmptyComponent();
