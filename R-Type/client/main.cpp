...
int main(void)
{
    ...
    engine.getECS().getEntityManager().addMask(5, (eng::InfoEntity::SPRITEID | eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::PARALLAX));
    ...
    engine.getECS().getEntityManager().addMask(
        6, (eng::InfoEntity::POS | eng::InfoEntity::VEL | eng::InfoEntity::SPRITEID | eng::InfoEntity::SPEED | eng::InfoEntity::CONTROLLABLE | eng::InfoEntity::COOLDOWNSHOOT));
    ...
    engine.getECS().getComponentManager().initEmptyComponent(7);
