...
namespace eng
{
    ...
    class BossPreload : public EntityPreload
    {
        public:
             ...
             */
            static void preload(Graphic &graphic, EntityManager &entityManager, ComponentManager &componentManager, std::shared_ptr<std::size_t> syncId, sf::Vector2f position);
    };
}
