...
void eng::ParallaxPreload::preload(Engine &engine)
{
    ...
    componentManager.getComponent(typeid(SpriteAttribut)).emplaceData(id, SpriteAttribut{0, sf::FloatRect(0, 0, 640, 360), sf::Color::White, sf::Vector2f(3 / screenSize->x * windowsSize.x, 3 / screenSize->y * windowsSize.y)});
