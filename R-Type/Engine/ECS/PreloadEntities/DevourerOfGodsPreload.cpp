...
void DevourerPreload::preload(Graphic &graphic, EntityManager &entityManager, ComponentManager &componentManager)
{
    ...
    std::size_t lastId = 0;
    std::size_t id = entityManager.addMask((InfoComp::POS | InfoComp::VEL | InfoComp::SPRITEID | InfoComp::ENEMY | InfoComp::SIZE | InfoComp::PATTERN | InfoComp::SPRITEAT | InfoComp::GROUPEN | InfoComp::COOLDOWNACT | InfoComp::DROP), componentManager);
    ...
    for (std::size_t i = 0, newId = 0, sizeyDiff = 10; i < 8; i++) {
        ...
        newId = entityManager.addMask((InfoComp::POS | InfoComp::VEL | InfoComp::SPRITEID | InfoComp::ENEMY | InfoComp::SIZE | InfoComp::PATTERN | InfoComp::SPRITEAT | InfoComp::GROUPEN | InfoComp::PARENT | InfoComp::COOLDOWNSHOOT), componentManager);
