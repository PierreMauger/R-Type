...
Engine::Engine()
{
    ...
    this->_loader.loadSprites({"R-Type/Assets/Sprites", "R-Type/Assets/Sprites/Parallax", "R-Type/Assets/Sprites/DevourerOfGods", "R-Type/Assets/Sprites/CthulhuEye", "R-Type/Assets/Sprites/Bonus"});
}
