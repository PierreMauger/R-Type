...
namespace eng
{
    ...
    {
        private:
            void handleNewTcp(const boost::system::error_code &error, std::shared_ptr<Connection> newConnection, std::time_t time, std::size_t clientId);
            void initServerNetwork(std::time_t time, std::size_t clientId);
